...
image:
    ...
    alt: "Picture of the Rusty Statusphere"
head:
    meta:
      - name: "twitter:card"
        content: "summary"
      - name: "twitter:image"
        content: "https://baileytownsend.dev/article-assets/9/cover.png"
      - name: "keywords"    
        content: "rust, bluesky, atprotocol, bluesky, statusphere"
      - name: 'author'
...
![A screenshot of the app's status options"](/article-assets/9/emojis.png)
